...
use crate::{
    field::{Group, Ring},
    term::{MergeTerms, Normalize, flags::Flags},
};

impl<T: Group> std::ops::Add for &Term<T> {
    type Output = Term<T>;
...
impl<T: Group> std::ops::AddAssign<&Self> for Term<T> {
    fn add_assign(&mut self, rhs: &Self) {
        *self = &*self + rhs;
    }
}

impl<T: Group> std::ops::AddAssign for Term<T> {
    fn add_assign(&mut self, rhs: Self) {
        *self = &*self + &rhs;
    }
}

impl<T: Group> std::ops::Add<&Self> for Term<T> {
    type Output = Self;
...
impl<T: Group> std::ops::Neg for Term<T> {
    type Output = Self;
...
impl<T: Group> std::ops::Sub for &Term<T> {
    type Output = Term<T>;
...
impl<T: Group> std::ops::SubAssign for Term<T> {
    fn sub_assign(&mut self, rhs: Self) {
        *self = &*self - &rhs;
    }
}

impl<T: Group> std::ops::Sub<&Self> for Term<T> {
    type Output = Self;
